<template lang="">
        ...
        <div class="c-body-card">
            ...
            <div class="c-body-content" :style="guide ? {height: '70vh' } : {height: '30rem'}">
                ...
                <div class="content-container"  > 
                    <div v-for="(seg, index) in leanChannel" :key="index" class="lean-content-card">
    ...
    <!-- add new modal   -->
        <modal
            ...
            <h2 class="modal-title">Add Channel</h2>
            <form @submit.prevent="addContent">
                <div class="input-container">
                    <input type="text" class="material-input" id="topic" v-model="contentForm.topic" >
                    <label for="topic" class="material-label">Channel</label>
                </div>

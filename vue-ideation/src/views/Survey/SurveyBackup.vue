...
export default {
  ...
  data() {
    return {
      ...
      currentQuestion: this.steps[0].question,
      currentAnswer: "",
      userAnswer: {},
      steps: [
        {
          question: "How did you discover" + this.productName,
          answer: [
        ...
        {
          question:
            "How would you feel if you could no longer use" + this.productName,
          answer: [
            "Very Disappointed",
        ...
        },
        {
          question:
            "If" +
            " " +
            "is no longer available, what would you use as an alternative?",
          answer: ["I probably wouldn’t use an alternative", "I would use"],
        },
        {
          question:
            "What is the primary benefit you received from " + this.productName,
          answer: "textinput",
        },
        {
          question: "Have you recommended" + this.productName + "to anyone?",
          answer: ["No", "Yes"],
        },
        {
          question:
